...
adminRoutes.post("/user/edit", isAuth, imageUpload.single("image"), adminController.post_person_edit);
...
adminRoutes.get("/userDetail", adminController.get_userDetail);
adminRoutes.get("/user", adminController.get_user);
adminRoutes.post("/login", adminController.post_login);
